...
double flux_perc_m;        // flux from soil to deeper groundwater reservoir
...
//---------------------------------------
double soil_moisture_deficit_m;
...
for(tstep=0;tstep<num_timesteps;tstep++)
  ...
  if(soil_moisture_deficit_m<infiltration_depth_m)
    {
    Schaake_output_runoff_m+=(infiltration_depth_m-soil_moisture_deficit_m);  // put won't fit back into runoff
