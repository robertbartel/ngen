...
// becomes a JSON property. Rows come from the fixture written by write_example_aux(), whose
// attribute tables between them hold a cell of every storage class.
class Properties_Test : public ::testing::Test
{
  protected:
    void SetUp() override
    {
        ...
        this->db = std::make_unique<ngen::sqlite::database>(
            ngen::geopackage::fixtures::write_example_aux()
        );
    }
